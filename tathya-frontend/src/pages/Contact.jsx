...
const Contact = () => {
  ...
  // If user is a moderator, don't show the contact page content
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Moderators do not have access to the contact page.
          </motion.p>
          <motion.div
            className="mt-8"
            initial={{ opacity: 0 }}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <i className="fas fa-clock text-green-500 mr-3"></i> Office Hours
              </h2>
            ...
            >
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <i className="fas fa-hashtag text-purple-500 mr-3"></i> Connect With Us
              </h2>
          ...
          >
            ...
            <AnimatePresence>
              {isSubmitted ? (
                ...
                >
                  <i className={`text-5xl mb-4 ${submitSuccess ? 'fas fa-check-circle text-green-500' : 'fas fa-exclamation-circle text-red-500'}`}></i>
                  <h3 className={`text-2xl font-bold mb-2 ${submitSuccess ? 'text-gray-800' : 'text-red-600'}`}>
                    {submitSuccess ? 'Message Sent Successfully!' : 'Error Sending Message'}
                  </h3>
                  <p className="text-gray-600 mb-4">
                    {submitSuccess 
                      ? 'Thank you for contacting us. Your message has been received by our moderators. Replies from moderators will be visible in your User Dashboard under the "Moderator Messages" section.' 
                      : submitError}
                  </p>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      } rounded-md focus:ring-blue-500 focus:border-blue-500 transition-colors shadow-sm`}
        ...
        >
          <p className="mb-2">We value your feedback and strive to respond to all inquiries within 24-48 business hours.</p>
          <p>For urgent matters, please use the contact information provided above.</p>
        </motion.div>
      </div>
    </div>
  );
